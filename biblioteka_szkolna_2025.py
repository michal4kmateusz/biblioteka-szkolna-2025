...
# === DANE ===
klienci = ["Kowalski Jan", "Nowak Anna", "Wiśniewska Ola", "Zieliński Tomek", "Jankowska Maria", "Lewandowska Zofia", "Kaczmarek Piotr"]
...
# === OKNO GŁÓWNE Z IDEALNYM SCROLLEM ===
root = tk.Tk()
...
# === AKCJE – MNIEJSZE PRZYCISKI, IDEALNIE DO LEWEJ (8px) ===
